...
<?php echo $this->Form->create('PphlUser'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pphl User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PphlUser.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PphlUser.id'))); ?></li>
